...
function s.initial_effect(c)
	...
	c:RegisterEffect(e3)
	--Add 1 "Medicina do Chopper" card to the hand
...
function s.spfilter(c)
	return c:IsFaceup() and c:IsSetCard(0xa05) and c:IsAbleToDeckAsCost()
end
...
function s.desfilter(c)
	return c:IsMonster() and c:IsSetCard(0xa05) and (c:IsLocation(LOCATION_HAND) or c:IsFaceup())
end
function s.pubfilter(c)
	return c:IsPublic() and c:IsMonster() and c:IsSetCard(0xa05)
end
...
function s.thfilter(c)
	return c:IsCode(848814271) and c:IsAbleToHand()
end
