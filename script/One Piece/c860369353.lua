...
function s.filter(c)
    return c:IsSetCard(0xa05) and c:IsAbleToHand()
end
...
function s.atkcon(e, tp, eg, ep, ev, re, r, rp)
    ...
    e:SetLabelObject(c)
    return c and c ~= e:GetHandler() and c:IsType(TYPE_MONSTER) and c:IsSetCard(0xa05) and c:IsRelateToBattle()
end
